class CustomRegistrationsController < Devise::RegistrationsController
  ...
  def create_wants(user)
    ...
    Want.create(weight: 0, protein: (protein_better).round, fat: calc_fat, carbohydrate: calc_carbohydrate, diet_weight: 0.5, diet_protein: calc_diet_protein, diet_fat: calc_diet_fat, diet_carbohydrate: calc_diet_carbohydrate, user_id: user.id)
  end
end
